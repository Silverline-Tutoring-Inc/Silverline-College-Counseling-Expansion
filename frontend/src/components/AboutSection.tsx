      ...
      <div className="container">
        <div className="row align-items-center">
          <div className="col-lg-6">
            <span className="subheading" data-aos="fade-up">About Us</span>
            <h2 className="heading mb-3" data-aos="fade-up" data-aos-delay="100">Support Our Cause</h2>
            ...
            <p className="my-6" data-aos="fade-up" data-aos-delay="300"><a href="about.html"
              className="btn btn-primary">Read
              more</a></p>
          </div>
          <div className="col-lg-6 pt-4 px-4">
            <div className="row">
              <div className="col-12 col-lg-12" data-aos="fade-up" data-aos-delay="400">
