          ...
          <div className="site-navigation">
            <ul className="js-clone-nav d-none d-lg-inline-block text-start site-menu float-start">
              ...
              <li className="has-children non">
                <button style={{ background: 'none', color: '#D7D6DA', border: 'none', paddingLeft: '20px', font: 'inherit', cursor: 'pointer', outline: 'inherit' }}>About Us ▾</button>
            ...
            <ul className="js-clone-nav d-none d-lg-inline-block text-end site-menu float-end">
              ...
              <li className="social-top">
                <a href="https://discord.gg/kD8aMaX2gP" target="_blank" rel="noopener noreferrer"><span className="icon-link" /></a>
                <a href="https://www.instagram.com/silverlinetutoringinc/?igshid=YmMyMTA2M2Y%3D" target="_blank" rel="noopener noreferrer"><span className="icon-instagram" /></a>
                <a href="https://www.youtube.com/channel/UCc-c1_wUoQPavLeKE5I2_aA" target="_blank" rel="noopener noreferrer"><span className="icon-youtube" /></a>
                <a href="https://m.facebook.com/people/Silverline-Tutoring/100078405522496/" target="_blank" rel="noopener noreferrer"><span className="icon-facebook" /></a>
                <a href="https://www.linkedin.com/company/silverline-tutoring-services/" target="_blank" rel="noopener noreferrer"><span className="icon-linkedin" /></a>
              </li>
            </ul>
      ...
      <div className="section overlay" style={{ backgroundImage: "url('images/about/sBG.png')", backgroundSize: 'cover', backgroundRepeat: 'repeat', backgroundPosition: 'center center' }}>
        ...
        <div className="row align-items-center">
          <div className="col-lg-12">
            <h1 data-aos="fade-up" style={{ color: '#918CA1', fontFamily: "'Work Sans', sans-serif", fontWeight: 800 }}>About Silverline</h1>
